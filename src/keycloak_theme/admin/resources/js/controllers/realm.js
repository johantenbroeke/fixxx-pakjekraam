...
function getAccessObject(Auth, Current) {
    return {
        ...
        get viewRealm() {
            return (
                getAccess(Auth, Current, 'view-realm') || getAccess(Auth, Current, 'manage-realm') || this.manageRealm
            );
        },
        ...
        get viewUsers() {
            return (
                getAccess(Auth, Current, 'view-users') || getAccess(Auth, Current, 'manage-users') || this.manageClients
            );
        },
...
module.controller('RealmCreateCtrl', function(
    $scope,
    Current,
    Realm,
    $upload,
...
module.controller('RealmDetailCtrl', function(
    $scope,
    Current,
    Realm,
    realm,
...
module.controller('DefenseHeadersCtrl', function(
    $scope,
    Current,
    Realm,
    realm,
...
module.controller('RealmLoginSettingsCtrl', function(
    $scope,
    Current,
    Realm,
    realm,
...
module.controller('RealmThemeCtrl', function(
    $scope,
    Current,
    Realm,
    realm,
...
module.controller('RealmCacheCtrl', function(
    $scope,
    realm,
    RealmClearUserCache,
...
module.controller('RealmPasswordPolicyCtrl', function(
    $scope,
    Realm,
    realm,
    $http,
...
module.controller('RealmDefaultRolesCtrl', function(
    $scope,
    Realm,
    realm,
    clients,
...
module.controller('RealmIdentityProviderCtrl', function(
    $scope,
    $filter,
    $upload,
    $http,
    ...
    $scope.importFrom = function() {
        ...
        $http
            .post(authUrl + '/admin/realms/' + realm.realm + '/identity-provider/import-config', input)
            .then(function(response) {
                setConfig(response.data);
                $scope.fromUrl.data = '';
                $scope.importUrl = false;
...
module.controller('RealmIdentityProviderExportCtrl', function(
    realm,
    identityProvider,
    $scope,
    $http,
    IdentityProviderExport,
) {
    $scope.realm = realm;
...
module.controller('RealmTokenDetailCtrl', function(
    $scope,
    Realm,
    realm,
    $http,
    ...
    $scope.$watch(
        ...
        function() {
            ...
            $scope.actionTokenAttribute = TimeUnit2.asUnit(
                $scope.realm.attributes['actionTokenGeneratedByUserLifespan.' + $scope.actionLifespanId],
            );
        },
        true,
    );
...
module.controller('RealmKeysCtrl', function(
    $scope,
    Realm,
    realm,
    $http,
    ...
    Components.query({ realm: realm.realm, parent: realm.id, type: 'org.keycloak.keys.KeyProvider' }, function(data) {
...
module.controller('RealmKeysProvidersCtrl', function(
    $scope,
    Realm,
    realm,
    $http,
...
module.controller('GenericKeystoreCtrl', function(
    $scope,
    $location,
    Notifications,
    $route,
...
module.controller('RealmSessionStatsCtrl', function(
    $scope,
    realm,
    stats,
...
module.controller('RealmRevocationCtrl', function(
    $scope,
    Realm,
    RealmPushRevocation,
    realm,
...
module.controller('RoleListCtrl', function(
    $scope,
    $route,
    Dialog,
    Notifications,
...
module.controller('RoleDetailCtrl', function(
    $scope,
    realm,
    role,
    roles,
...
module.controller('RealmSMTPSettingsCtrl', function(
    $scope,
    Current,
    Realm,
    realm,
    ...
    $scope.testConnection = function() {
        RealmSMTPConnectionTester.send(
            initSMTPTest(),
            function() {
...
module.controller('RealmEventsConfigCtrl', function(
    $scope,
    eventsConfig,
    RealmEventsConfig,
    RealmEvents,
...
module.controller('RealmBruteForceCtrl', function(
    $scope,
    Realm,
    realm,
    $http,
...
module.controller('IdentityProviderMapperCtrl', function(
    $scope,
    realm,
    identityProvider,
    mapperTypes,
    ...
    $scope.remove = function() {
        Dialog.confirmDelete($scope.mapper.name, 'mapper', function() {
            IdentityProviderMapper.remove(
                { realm: realm.realm, alias: mapper.identityProviderAlias, mapperId: $scope.mapper.id },
                function() {
...
module.controller('IdentityProviderMapperCreateCtrl', function(
    $scope,
    realm,
    identityProvider,
    mapperTypes,
...
module.controller('RealmFlowBindingCtrl', function(
    $scope,
    flows,
    Current,
    Realm,
...
module.controller('CreateFlowCtrl', function($scope, realm, AuthenticationFlows, Notifications, $location) {
...
module.controller('CreateExecutionFlowCtrl', function(
    $scope,
    realm,
    parentFlow,
    formProviders,
...
module.controller('CreateExecutionCtrl', function(
    $scope,
    realm,
    parentFlow,
    formActionProviders,
...
module.controller('AuthenticationFlowsCtrl', function(
    $scope,
    $route,
    realm,
    flows,
...
module.controller('RequiredActionsCtrl', function(
    $scope,
    realm,
...
module.controller('AuthenticationConfigCtrl', function(
    $scope,
    realm,
    flow,
    configType,
...
module.controller('AuthenticationConfigCreateCtrl', function(
    $scope,
    realm,
    flow,
    configType,
...
module.controller('ClientInitialAccessCtrl', function(
    $scope,
    realm,
    clientInitialAccess,
    ClientInitialAccess,
...
module.controller('ClientInitialAccessCreateCtrl', function(
    $scope,
    realm,
    ClientInitialAccess,
    TimeUnit,
...
module.controller('ClientRegPoliciesCtrl', function(
    $scope,
    realm,
...
module.controller('ClientRegPolicyDetailCtrl', function(
    $scope,
    realm,
    clientRegistrationPolicyProviders,
    instance,
...
module.controller('RealmImportCtrl', function($scope, realm, $route, Notifications, $modal, $resource) {
    $scope.rawContent = {};
    $scope.fileContent = {
        enabled: true,
    };
...
module.controller('RealmExportCtrl', function($scope, realm, $http, $httpParamSerializer, Notifications, Dialog) {
    $scope.realm = realm;
