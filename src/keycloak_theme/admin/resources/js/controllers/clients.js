...
module.controller('ClientRoleListCtrl', function(
    $scope,
    $location,
    realm,
    client,
...
module.controller('ClientCredentialsCtrl', function(
    $scope,
    $location,
    realm,
    client,
...
module.controller('ClientSecretCtrl', function($scope, $location, ClientSecret, Notifications) {
    var secret = ClientSecret.get({ realm: $scope.realm.realm, client: $scope.client.id }, function() {
...
module.controller('ClientSignedJWTCtrl', function($scope, $location, Client, ClientCertificate, Notifications, $route) {
    var signingKeyInfo = ClientCertificate.get(
        { realm: $scope.realm.realm, client: $scope.client.id, attribute: 'jwt.credential' },
        function() {
...
module.controller('ClientIdentityProviderCtrl', function(
    $scope,
    $location,
    $route,
    realm,
...
module.controller('ClientSamlKeyCtrl', function(
    $scope,
    $location,
    $http,
    $upload,
...
module.controller('ClientCertificateImportCtrl', function(
    $scope,
    $location,
    $http,
    $upload,
...
module.controller('ClientCertificateExportCtrl', function(
    $scope,
    $location,
    $http,
    $upload,
    ...
    var keyInfo = ClientCertificate.get({ realm: realm.realm, client: client.id, attribute: attribute }, function() {
...
module.controller('ClientSessionsCtrl', function($scope, realm, sessionCount, client, ClientUserSessions) {
    $scope.realm = realm;
...
module.controller('ClientOfflineSessionsCtrl', function(
    $scope,
    realm,
    offlineSessionCount,
    client,
...
module.controller('ClientRoleDetailCtrl', function(
    $scope,
    realm,
    client,
    role,
...
module.controller('ClientListCtrl', function(
    $scope,
    realm,
    Client,
    serverInfo,
    ...
    $scope.searchClient = function() {
        ...
        Client.query({ realm: realm.realm, viewableOnly: true, clientId: $scope.search.clientId }).$promise.then(
            function(clients) {
                $scope.numberOfPages = Math.ceil(clients.length / $scope.pageSize);
                $scope.clients = clients;
            },
...
module.controller('ClientInstallationCtrl', function(
    $scope,
    realm,
    client,
    serverInfo,
...
module.controller('ClientDetailCtrl', function(
    $scope,
    realm,
    client,
    flows,
    ...
    $scope.signatureAlgorithms = ['RSA_SHA1', 'RSA_SHA256', 'RSA_SHA512', 'DSA_SHA1'];
    ...
    function updateProperties() {
        ...
        if ($scope.client.attributes['saml.server.signature.keyinfo.xmlSigKeyInfoKeyNameTransformer'] === 'NONE') {
            ...
            $scope.client.attributes['saml.server.signature.keyinfo.xmlSigKeyInfoKeyNameTransformer'] === 'KEY_ID'
        ) {
            $scope.samlXmlKeyNameTranformer = $scope.xmlKeyNameTranformers[1];
        } else if (
            $scope.client.attributes['saml.server.signature.keyinfo.xmlSigKeyInfoKeyNameTransformer'] === 'CERT_SUBJECT'
        ) {
    ...
    $scope.samlIdpInitiatedUrl = function(ssoName) {
        return (
            encodeURI($location.absUrl().replace(/\/admin.*/, '/realms/') + realm.realm + '/protocol/saml/clients/') +
    ...
    $scope.changeSamlSigKeyNameTranformer = function() {
        $scope.clientEdit.attributes['saml.server.signature.keyinfo.xmlSigKeyInfoKeyNameTransformer'] =
    ...
    $scope.save = function() {
        ...
        if (
            ...
            ($scope.clientEdit.standardFlowEnabled || $scope.clientEdit.implicitFlowEnabled) &&
            (!$scope.clientEdit.redirectUris || $scope.clientEdit.redirectUris.length == 0)
        ) {
...
module.controller('CreateClientCtrl', function(
    $scope,
    realm,
    client,
    $route,
...
module.controller('ClientScopeMappingCtrl', function(
    $scope,
    $http,
    realm,
    client,
    ...
    $scope.deleteRealmRole = function() {
        ...
        $scope.selectedRealmMappings = [];
        $http
            .delete(authUrl + '/admin/realms/' + realm.realm + '/clients/' + client.id + '/scope-mappings/realm', {
        ...
        $http
            .delete(
                authUrl +
                    ...
                    '/scope-mappings/clients/' +
                    $scope.targetClient.id,
                { data: $scope.selectedClientMappingsToRemove, headers: { 'content-type': 'application/json' } },
            )
            .then(function() {
                updateClientRoles();
...
module.controller('ClientRevocationCtrl', function(
    $scope,
    realm,
    client,
    Client,
...
module.controller('ClientClusteringCtrl', function(
    $scope,
    client,
    Client,
...
module.controller('ClientClusteringNodeCtrl', function(
    $scope,
    client,
    Client,
    ClientClusterNode,
...
module.controller('AddBuiltinProtocolMapperCtrl', function(
    $scope,
    realm,
    client,
    serverInfo,
...
module.controller('ClientProtocolMapperListCtrl', function(
    $scope,
    realm,
    client,
    serverInfo,
...
module.controller('ClientProtocolMapperCtrl', function(
    $scope,
    realm,
    serverInfo,
    client,
...
module.controller('ClientProtocolMapperCreateCtrl', function(
    $scope,
    realm,
    serverInfo,
    client,
...
module.controller('ClientClientScopesSetupCtrl', function(
    $scope,
    realm,
    Realm,
    client,
...
module.controller('ClientClientScopesEvaluateCtrl', function(
    $scope,
    Realm,
    User,
...
module.controller('ClientScopeListCtrl', function(
    $scope,
    realm,
    clientScopes,
    ClientScope,
...
module.controller('ClientScopesRealmDefaultCtrl', function(
    $scope,
    realm,
    Realm,
    clientScopes,
...
module.controller('ClientScopeDetailCtrl', function(
    $scope,
    realm,
    clientScope,
    $route,
...
module.controller('ClientScopeProtocolMapperListCtrl', function(
    $scope,
    realm,
    clientScope,
    serverInfo,
...
module.controller('ClientScopeProtocolMapperCtrl', function(
    $scope,
    realm,
    serverInfo,
    clientScope,
    ...
    $scope.remove = function() {
        Dialog.confirmDelete($scope.model.mapper.name, 'mapper', function() {
            ClientScopeProtocolMapper.remove(
                { realm: realm.realm, clientScope: clientScope.id, id: $scope.model.mapper.id },
                function() {
                    Notifications.success('The mapper has been deleted.');
...
module.controller('ClientScopeProtocolMapperCreateCtrl', function(
    $scope,
    realm,
    serverInfo,
    clientScope,
...
module.controller('ClientScopeAddBuiltinProtocolMapperCtrl', function(
    $scope,
    realm,
    clientScope,
    serverInfo,
    ...
    var updateMappers = function() {
        var clientMappers = ClientScopeProtocolMappersByProtocol.query(
            { realm: realm.realm, clientScope: clientScope.id, protocol: clientScope.protocol },
            function() {
...
module.controller('ClientScopeScopeMappingCtrl', function(
    $scope,
    $http,
    realm,
    clientScope,
    ...
    $scope.deleteRealmRole = function() {
        ...
        $http
            .delete(
                authUrl + '/admin/realms/' + realm.realm + '/client-scopes/' + clientScope.id + '/scope-mappings/realm',
                { data: $scope.selectedRealmMappingsToRemove, headers: { 'content-type': 'application/json' } },
            )
            .then(function() {
                updateScopeRealmRoles();
                $scope.selectedRealmMappingsToRemove = [];
...
module.controller('ClientStoresCtrl', function(
    $scope,
    $location,
    $route,
    realm,
    ...
    Components.query(
        { realm: realm.realm, parent: realm.id, type: 'org.keycloak.storage.client.ClientStorageProvider' },
        function(data) {
...
module.controller('GenericClientStorageCtrl', function(
    $scope,
    $location,
    Notifications,
    $route,
    ...
    $scope.save = function() {
        ...
        if ($scope.create) {
            ...
            Components.update({ realm: realm.realm, componentId: instance.id }, $scope.instance, function() {
                $route.reload();
