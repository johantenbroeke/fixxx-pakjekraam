...
module.controller('ResourceServerDetailCtrl', function(
    $scope,
    $http,
    $route,
    $location,
            ...
            function(permissions) {
                ...
                AuthzDialog.confirmDeleteWithMsg($scope.resource.name, 'Resource', msg, function() {
                    ResourceServerResource.delete(
                        { realm: realm, client: $scope.client.id, rsrid: $scope.resource._id },
                        null,
                        function() {
                            $location.url(
...
module.controller('ResourceServerResourceCtrl', function(
    $scope,
    $http,
    $route,
    $location,
                        ...
                        $scope.save = function() {
                            ...
                            $instance.checkNameAvailability(function() {
                                ResourceServerResource.update(
                                    { realm: realm.realm, client: $scope.client.id, rsrid: $scope.resource._id },
                                    $scope.resource,
                                    function() {
                                        $route.reload();
...
module.controller('ResourceServerScopeCtrl', function(
    $scope,
    $http,
    $route,
    $location,
    ...
    ResourceServer.get(
        ...
        function(data) {
            ...
            $scope.createPolicy = function(scope) {
                viewState.state = {};
                viewState.state.previousUrl =
                    '/realms/' + $route.current.params.realm + '/clients/' + client.id + '/authz/resource-server/scope';
                $location
                    .path(
                        '/realms/' +
                            $route.current.params.realm +
...
module.controller('ResourceServerScopeDetailCtrl', function(
    $scope,
    $http,
    $route,
    $location,
                        ...
                        $scope.save = function() {
                            $instance.checkNameAvailability(function() {
                                ResourceServerScope.update(
                                    { realm: realm.realm, client: $scope.client.id, id: $scope.scope.id },
                                    $scope.scope,
                                    function() {
                                        $scope.changed = false;
...
module.controller('ResourceServerPolicyCtrl', function(
    $scope,
    $http,
    $route,
    $location,
...
module.controller('ResourceServerPermissionCtrl', function(
    $scope,
    $http,
    $route,
    $location,
...
module.controller('ResourceServerPolicyDroolsDetailCtrl', function(
    $scope,
    $http,
    $route,
    realm,
                    ...
                    $http
                        .post(
                            authUrl +
                                ...
                                '/clients/' +
                                client.id +
                                '/authz/resource-server/policy/rules/provider/resolveModules',
                            policy,
                        )
                    ...
                    $http
                        .post(
                            authUrl +
                                ...
                                '/clients/' +
                                client.id +
                                '/authz/resource-server/policy/rules/provider/resolveSessions',
                            $scope.policy,
                        )
                        .then(function(response) {
...
module.controller('ResourceServerPolicyResourceDetailCtrl', function(
    $scope,
    $route,
    $location,
    realm,
...
module.controller('ResourceServerPolicyScopeDetailCtrl', function(
    $scope,
    $route,
    $location,
    realm,
...
module.controller('ResourceServerPolicyUserDetailCtrl', function(
    $scope,
    $route,
    realm,
    client,
            ...
            onInit: function() {
                $scope.usersUiSelect = {
                    ...
                    query: function(query) {
                        ...
                        User.query({ realm: $route.current.params.realm, search: query.term.trim(), max: 20 }, function(
                            response,
                        ) {
                            data.results = response;
                            query.callback(data);
...
module.controller('ResourceServerPolicyClientDetailCtrl', function(
    $scope,
    $route,
    realm,
    client,
            ...
            onInit: function() {
                $scope.clientsUiSelect = {
                    ...
                    query: function(query) {
                        ...
                        Client.query(
                            { realm: $route.current.params.realm, search: query.term.trim(), max: 20 },
                            function(response) {
...
module.controller('ResourceServerPolicyRoleDetailCtrl', function(
    $scope,
    $route,
    realm,
    client,
    ...
    PolicyController.onInit(
        {
            ...
            onInit: function() {
                ...
                $scope.selectClient = function() {
                    ...
                    ClientRole.query({ realm: $route.current.params.realm, client: $scope.selectedClient.id }, function(
                        data,
                    ) {
                        var roles = [];
...
module.controller('ResourceServerPolicyGroupDetailCtrl', function(
    $scope,
    $route,
    realm,
    client,
    ...
    PolicyController.onInit(
        {
            ...
            onInit: function() {
                ...
                Groups.query({ realm: $route.current.params.realm }, function(groups) {
                    $scope.groups = groups;
                    $scope.groupList = [{ id: 'realm', name: 'Groups', subGroups: groups }];
                });
...
module.controller('ResourceServerPolicyJSDetailCtrl', function(
    $scope,
    $route,
    $location,
    realm,
...
module.controller('ResourceServerPolicyTimeDetailCtrl', function(
    $scope,
    $route,
    $location,
    realm,
...
module.controller('ResourceServerPolicyAggregateDetailCtrl', function(
    $scope,
    $route,
    $location,
    realm,
...
module.service('PolicyController', function(
    $http,
    $route,
    $location,
    ResourceServer,
    ...
    PolicyController.onInit = function(delegate, realm, client, $scope) {
        ...
        if (
            (!policyViewState.state || !PolicyController.isBackNewAssociatedPolicy()) &&
                ...
                if (!policyId) {
                    ...
                    $scope.save = function() {
                        $instance.checkNameAvailability(function() {
                            ...
                            service.save(
                                { realm: realm.realm, client: client.id, type: $scope.policy.type },
                                $scope.policy,
                                function(data) {
                                    if (delegate.isPermission()) {
                    ...
                    service.get(
                        ...
                        function(data) {
                            ...
                            $scope.changed =
                                $scope.historyBackOnSaveOrCancel || PolicyController.isBackNewAssociatedPolicy();
                            $scope.policy = angular.copy(policy);
...
module.controller('PolicyEvaluateCtrl', function(
    $scope,
    $http,
    $route,
    $location,
    ...
    $scope.save = function() {
        ...
        if ($scope.applyResourceType) {
            ...
            if (
                !$scope.newScopes ||
                ($scope.newResource._id != null && $scope.newScopes.length > 0 && $scope.newScopes[0].id)
            ) {
                $scope.newScopes = [];
            }
...
module.controller('RealmRolePermissionsCtrl', function(
    $scope,
    $http,
    $route,
    $location,
...
module.controller('UsersPermissionsCtrl', function(
    $scope,
    $http,
    $route,
    $location,
...
module.controller('GroupPermissionsCtrl', function(
    $scope,
    $http,
    $route,
    $location,
