...
module.directive('collapsable', function() {
    return function(scope, element, attrs) {
        element.click(function() {
            ...
            $(this)
                .find('.toggle-icons')
                .text($(this).text() == 'Icon: expand' ? 'Icon: collapse' : 'Icon: expand');
            $(this)
                .parent()
                .find('.form-group')
                .toggleClass('hidden');
...
module.controller('RoleSelectorModalCtrl', function(
    $scope,
    realm,
    config,
    configName,
...
module.controller('ComponentRoleSelectorModalCtrl', function(
    $scope,
    realm,
    config,
    configName,
