...
module.factory('AuthenticationFormActionProvidersLoader', function(
    Loader,
    AuthenticationFormActionProviders,
    $route,
    $q,
) {
...
module.factory('PerClientAuthenticationConfigDescriptionLoader', function(
    Loader,
