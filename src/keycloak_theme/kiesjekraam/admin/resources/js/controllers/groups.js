module.controller('GroupListCtrl', function(
    $scope,
    $route,
    $q,
    realm,
...
module.controller('GroupCreateCtrl', function(
    $scope,
    $route,
    realm,
    parentId,
...
module.controller('GroupRoleMappingCtrl', function(
    $scope,
    $http,
    realm,
    group,
    ...
    $scope.deleteRealmRole = function() {
        ...
        $http
            .delete(authUrl + '/admin/realms/' + realm.realm + '/groups/' + group.id + '/role-mappings/realm', {
