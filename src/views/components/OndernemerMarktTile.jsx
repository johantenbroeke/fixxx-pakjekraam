...
const OndernemerMarktTile = ({ markt, aanmeldingVandaag, aanmeldingMorgen, toewijzingVandaag, toewijzingMorgen, time, geopend, eggie }) => {
    return (
        <div className="OndernemerMarktTile well background-link-parent">
            ...
            { time.getHours() > 21 && time.getHours() < 24 && geopend ? (
               <div className="OndernemerMarktTile__update-row">
                <h4 className="OndernemerMarktTile__update-row__heading">Morgen ({aanmeldingMorgen.marktDate})
                ...
                { !toewijzingMorgen && eggie ? (
                    <AlertLine type="success" title="Ingedeeld" titleSmall={true} message={`Jouw plekken: ${toewijzingMorgen.plaatsen.join(', ')}`} inline={true}></AlertLine>
               ) : eggie ? (
                   <span> geen toewijzing </span>
               ) : null }
                </div>
            ) : null }
            { time.getHours() >= 0 && time.getHours() < 18 && geopend ? (
                <div className="OndernemerMarktTile__update-row">
                    <h4 className="OndernemerMarktTile__update-row__heading">Vandaag ({aanmeldingMorgen.marktDate})
                     ...
                     { toewijzingVandaag && eggie ? (
                         <AlertLine type="success" title="Ingedeeld" titleSmall={true} message={`Jouw plekken: ${toewijzingVandaag.plaatsen.join(', ')}`} inline={true}></AlertLine>
                    )  : eggie ? (
                        <span>Geen toewijzing </span>
                    ) : null}
                </div>
